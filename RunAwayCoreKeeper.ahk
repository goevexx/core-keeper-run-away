...
readyToStart := false
startRunning := false
instructions := "1. Open Core Keeper.`n2. Move your character to a position so that you have enough space to move in all directions.`n3. Press CTRL + F to get started power up your running skill.`n`nControls:`nPress CTRL + F to stop/start the procedure`nPress CTRL + Q to quit this script"
